...
/**
 * One optional claim/region/land plugin, adapted to SmartSpawner's spawner actions.
 *
...
public interface ProtectionHook {
    ...
    /** @return true if the player may sell from the spawner at this location. */
    default boolean canSell(Player player, Location location) {
        return true;
    }
}