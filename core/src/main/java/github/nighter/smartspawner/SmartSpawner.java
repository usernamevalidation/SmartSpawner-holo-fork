...
import github.nighter.smartspawner.commands.sellwand.SellwandGUI;
import github.nighter.smartspawner.commands.sellwand.SellwandListener;
import github.nighter.smartspawner.spawner.sell.SellwandSellListener;
...
public class SmartSpawner extends JavaPlugin implements SmartSpawnerPlugin {
    ...
    // Sellwand sacrifice GUI
    private SellwandGUI sellwandGUI;
    private SellwandListener sellwandListener;
    private SellwandSellListener sellwandSellListener;
    ...
    private github.nighter.smartspawner.commands.hologram.HologramVisibilityTask hologramVisibilityTask;
    ...
    private void initializeUIAndActions() {
        ...
        this.sellwandGUI = new SellwandGUI(this);
        this.sellwandListener = new SellwandListener(this, sellwandGUI);
        this.sellwandSellListener = new SellwandSellListener(this);
    }
    ...
    private void registerListeners() {
        ...
        // Register sellwand GUI listeners
        pm.registerEvents(sellwandListener, this);
        pm.registerEvents(sellwandSellListener, this);
    }
    ...
    public void reload() {
        ...
        // Re-read hologram visibility/cleanup settings and restart the tasks
        if (hologramVisibilityTask != null) {
    ...
    private void cleanupResources() {
        ...
        if (hologramVisibilityTask != null) hologramVisibilityTask.stop();
