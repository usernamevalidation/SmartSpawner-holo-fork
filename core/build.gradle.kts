...
dependencies {
    ...
    // AxSellWands' container API — lets SmartSpawner blocks be sold through sellwands.
    // Never shaded; the server either has AxSellWands or the integration stays dormant.
    compileOnly(files("libs/AxSellWands.jar"))
